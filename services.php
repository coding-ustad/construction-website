...
<!-- Mirrored from themedox.com/demo/steelcity/services.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 22 Nov 2023 10:33:37 GMT -->
<head>
    <meta charset="UTF-8">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarScroll">
                    <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="#">Services <i class="fas fa-chevron-down"></i></a>
                            <ul class="list-unstyled sub-menu">
    ...
    <main>
                ...
                <div class="row">
                        ...
                        <div class="all-services-item">
                            <div class="image">
                                <a href="service-details.html" class="d-block w-100">
                                    <img src="assets/img/services/all-service-image-1.png" alt="all-service-image-1"
                                        class="img-fluid w-100">
                                </a>
                                <div class="icon">
                                    <img src="assets/img/icons/service-icon-1.svg" alt="service-icon-1">
                                </div>
                            </div>
                            <div class="text">
                                <h4 class="title">
                                    <a href="service-details.html">Albert Flores</a>
                                </h4>
                                <p>It is a long established fact that a reader will be distracted by the readable
                                    content of a page
                                    layout loren ipsum</p>
                                <a href="service-details.html" class="read-more uppercase">Read More <i
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="all-services-item">
                            <div class="image">
                                <a href="service-details.html" class="d-block w-100">
                                    <img src="assets/img/services/all-service-image-2.png" alt="all-service-image-2"
                                        class="img-fluid w-100">
                                </a>
                                <div class="icon">
                                    <img src="assets/img/icons/service-icon-2.svg" alt="service-icon-2">
                                </div>
                            </div>
                            <div class="text">
                                <h4 class="title">
                                    <a href="service-details.html">Strong Haven</a>
                                </h4>
                                <p>It is a long established fact that a reader will be distracted by the readable
                                    content of a page
                                    layout loren ipsum</p>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="all-services-item">
                            <div class="image">
                                <a href="service-details.html" class="d-block w-100">
                                    <img src="assets/img/services/all-service-image-3.png" alt="all-service-image-3"
                                        class="img-fluid w-100">
                                </a>
                                <div class="icon">
                                    <img src="assets/img/icons/service-icon-3.svg" alt="service-icon-3">
                                </div>
                            </div>
                            <div class="text">
                                <h4 class="title">
                                    <a href="service-details.html">Elite Builders</a>
                                </h4>
                                <p>It is a long established fact that a reader will be distracted by the readable
                                    content of a page
                                    layout loren ipsum</p>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="all-services-item">
                            <div class="image">
                                <a href="service-details.html" class="d-block w-100">
                                    <img src="assets/img/services/all-service-image-4.png" alt="all-service-image-4"
                                        class="img-fluid w-100">
                                </a>
                                <div class="icon">
                                    <img src="assets/img/icons/service-icon-1.svg" alt="service-icon-4">
                                </div>
                            </div>
                            <div class="text">
                                <h4 class="title">
                                    <a href="service-details.html">Golden Worker</a>
                                </h4>
                                <p>It is a long established fact that a reader will be distracted by the readable
                                    content of a page
                                    layout loren ipsum</p>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="all-services-item">
                            <div class="image">
                                <a href="service-details.html" class="d-block w-100">
                                    <img src="assets/img/services/all-service-image-5.png" alt="all-service-image-5"
                                        class="img-fluid w-100">
                                </a>
                                <div class="icon">
                                    <img src="assets/img/icons/service-icon-2.svg" alt="service-icon-5">
                                </div>
                            </div>
                            <div class="text">
                                <h4 class="title">
                                    <a href="service-details.html">Strong Building</a>
                                </h4>
                                <p>It is a long established fact that a reader will be distracted by the readable
                                    content of a page
                                    layout loren ipsum</p>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="all-services-item">
                            <div class="image">
                                <a href="service-details.html" class="d-block w-100">
                                    <img src="assets/img/services/all-service-image-6.png" alt="all-service-image-6"
                                        class="img-fluid w-100">
                                </a>
                                <div class="icon">
                                    <img src="assets/img/icons/service-icon-3.svg" alt="service-icon-6">
                                </div>
                            </div>
                            <div class="text">
                                <h4 class="title">
                                    <a href="service-details.html">Elite Company</a>
                                </h4>
                                <p>It is a long established fact that a reader will be distracted by the readable
                                    content of a page
                                    layout loren ipsum</p>
        ...
        <section class="call-to-action-area">
            <div class="row">
                <div class="col-lg-6">
                    <div class="image">
                        <img src="assets/img/images/call-to-action-image.png" alt="call-to-action-image"
                            class="img-fluid w-100">
                    </div>
                </div>
                            ...
                            <div class="footer-widget ms-5">
                                ...
                                <div class="footer-link">
                                    <ul>
                                        ...
                                        <li><a href="#"><i class="fas fa-angle-right"></i> Network Solutions</a></li>
                                        <li><a href="#"><i class="fas fa-angle-right"></i> Others</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="footer-bottom">
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            <div class="copyright">
                                <p>© SteelCity 2023 | All Rights Reserved</p>
                            </div>
                        </div>
                        <div class="col-12 col-lg-6">
...
<!-- Mirrored from themedox.com/demo/steelcity/services.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 22 Nov 2023 10:33:38 GMT -->
</html>